...
import CustomCTAButton from "../CustomCTAButton/CustomCTAButton";
...
function PrivacyPolicyView() {
    ...
    return (
        <AppContainer>
            ...
            <H4Text variant="h4"><strong>Privacy Policy</strong></H4Text>
            <H5Text variant="h5">
                <p>Our Privacy Policy was last updated on June, 15th 2023.</p>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>"Company"</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to STYLECARD </p>
                    ...
                    <li>
                        <p><strong>"Website"</strong> refers to STYLECARD WEB APP / API, accessible from https://stylecard-api.herokuapp.com/</p>
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        <p>Body Measurement Data, such as the values in cetimeters or inches for the size of Chest, Waist and Hip, and other body parts relevant for the purpose of infering garment size</p>
                    </li>
                </ul>
            ...
            <CustomCTAButton
                ...
                label={"Go Back"}
                variant={"left"}
                style={{ position: "absolute", bottom: "40px", width: "80%" }}
            />
        </AppContainer>
    );
}
